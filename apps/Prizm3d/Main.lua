...
{"guild-btru", "Вывеска сервера Guild-bt.ru"},
{"2077", "надпись 2077, прямо из будущего"},
{"adminshop", "Вывеска *АДМИНШОП*"},
{"magaz2", "Вывеска *МАГАЗИН*"},
{"auk", "Вывеска *АУКЦИОН*"},
{"aliexprss", "Вывеска *AliExpress*"},
{"donotenter", "Надпись *Не входить* на полосатом фоне"},
{"labirinth", "Лабиринт"},
{"vopros", "Знак вопроса"},
